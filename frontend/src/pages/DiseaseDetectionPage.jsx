...
export default function DiseaseDetectionPage({ user }) {
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .section-title { font-weight: bold; color: #1a5c1a; margin-bottom: 5px; }
        ...
        <body>
          ...
          <div id="print-content">${formatResultForPrint(result)}</div>
          <div class="footer">
  ...
  const formatResultForPrint = (result) => {
    if (!result) return '';
    
    // Clean up the result by removing markdown and HTML tags
  ...
  const extractSection = (text, sectionName) => {
    ...
    let sectionContent = text.substring(sectionIndex + sectionName.length + 1, sectionEnd).trim();
      ...
      <div className="space-y-4">
        {sections.disease && (
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            <p dangerouslySetInnerHTML={{ __html: sections.disease }} />
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {sections.symptoms && (
            <div className="bg-yellow-50 p-4 rounded-lg">
              ...
              <p dangerouslySetInnerHTML={{ __html: sections.symptoms }} />
            </div>
          )}
          ...
          {sections.cause && (
            <div className="bg-red-50 p-4 rounded-lg">
              ...
              <p dangerouslySetInnerHTML={{ __html: sections.cause }} />
            </div>
          )}
          ...
          {sections.severity && (
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p dangerouslySetInnerHTML={{ __html: sections.severity }} />
            </div>
          )}
          ...
          {sections.timeline && (
            <div className="bg-purple-50 p-4 rounded-lg">
              ...
              <p dangerouslySetInnerHTML={{ __html: sections.timeline }} />
            </div>
          )}
        </div>
        ...
        {sections.treatment && (
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            <p dangerouslySetInnerHTML={{ __html: sections.treatment }} />
          </div>
        )}
        ...
        {sections.prevention && (
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p dangerouslySetInnerHTML={{ __html: sections.prevention }} />
          </div>
        )}
        ...
        {sections.notes && (
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p dangerouslySetInnerHTML={{ __html: sections.notes }} />
          </div>
        )}
      </div>
    );
